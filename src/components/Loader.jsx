  ...
  return (
    <>
      {items.map(() => (
        <div
          role="status"
          class="max-w-sm p-4  border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
        >
          <div class="flex items-center justify-center h-52 w-full mb-4 bg-gray-300 rounded dark:bg-gray-700"></div>
